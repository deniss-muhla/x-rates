...
const GetPrevRatesButton: FunctionComponent<GetPrevRatesButtonProps> = ({
    isPending,
    isEmptyRates,
    onClick
}) => {
...
GetPrevRatesButton.displayName = 'GetPrevRatesButton';

export default GetPrevRatesButton;
